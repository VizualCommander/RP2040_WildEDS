// Generated by SolidPython 1.1.3 on 2022-02-23 10:31:50
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.4500000000) {
					offset(r = 1.0000000000) {
						import(file = "/home/jlchacos/Documents/RP2040_WildEDS/Production/WildEDS_stencil/RP2040_WEDS-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.6000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "/home/jlchacos/Documents/RP2040_WildEDS/Production/WildEDS_stencil/RP2040_WEDS-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
